	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-8 text-left">
				...
				<form:form method="post" action="/searchUser" modelAttribute="user">
					<table align="center">

						<tr>
							<td colspan="2"><h3 align="center">Search</h3></td>
						</tr>

						<tr>
							<td>User Name:</td>
							<td><form:input type="text" class="form-control"
									path="username" id="username" /></td>
							<td></td>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${not empty user.successMessage}">
					<table border="1" align="center">
						...
						<tr>
							<td>${user.username}</td>
							<td>${user.email}</td>
							<td><a href="/updateUserPage/${user.username}">Update</a> | <a href="/deleteUserPage/${user.id}">Delete</a></td>
