	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-8 text-left">
				...
				<form:form method="post" action="/searchTeacher" modelAttribute="teacher">
					<table align="center">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${not empty teacher.successMessage}">
					<table border="1" align="center">
						...
						<tr>
							...
							<td><a href="/updateTeacherPage/${teacher.name}">Update</a> | <a href="/deleteTeacherPage/${teacher.id}">Delete</a></td>
