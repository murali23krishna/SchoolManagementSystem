	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-8 text-left">
				...
				<form:form method="post" action="/searchStudent" modelAttribute="student">
					<table align="center">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${not empty student.successMessage}">
					<table border="1" align="center">
						...
						<tr>
							...
							<td><a href="/updateStudentPage/${student.name}">Update</a> | <a href="/deleteStudentPage/${student.id}">Delete</a></td>
